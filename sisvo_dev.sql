...
INSERT INTO `msc_usuarios` (`usuario_id`, `empresa_id`, `rol_id`, `username`, `email`, `password_hash`, `pin_autorizacion`, `nombre`, `apellido_paterno`, `apellido_materno`, `telefono`, `estatus_id`, `intentos_fallidos`, `esta_bloqueado`, `token_sesion`, `ultimo_acceso`, `actualiza_password`, `usuario_registro`, `fecha_registro`, `usuario_actualiza`, `fecha_actualiza`) VALUES
	(4, 1, 1, 'admin_juan', 'juan.perez@empresa1.com', '100000.mf0o9cf/vIvfyKWwlTtutg==.oXW41SkR0/lLbFMERs142tR/eD5x/r6cHpvn7nH5kgM=', '1234', 'Juan', 'Pérez', 'López', '5551234567', 1, 0, 0, NULL, '2026-08-24 08:30:00', '2026-08-24 08:30:00', 1, '2026-08-24 08:30:00', NULL, NULL),
	(5, 1, 2, 'marta_sup', 'marta.gomez@empresa1.com', '100000.mf0o9cf/vIvfyKWwlTtutg==.oXW41SkR0/lLbFMERs142tR/eD5x/r6cHpvn7nH5kgM=', NULL, 'Marta', 'Gómez', NULL, '5559876543', 1, 0, 0, NULL, NULL, NULL, 1, '2026-08-24 08:35:00', NULL, NULL),
	(6, 2, 3, 'carlos_op', 'carlos.ruiz@empresa2.com', '100000.mf0o9cf/vIvfyKWwlTtutg==.oXW41SkR0/lLbFMERs142tR/eD5x/r6cHpvn7nH5kgM=', '4321', 'Carlos', 'Ruiz', 'Díaz', NULL, 2, 3, 1, NULL, '2026-08-23 18:00:00', NULL, 1, '2026-08-20 10:00:00', 1, '2026-08-23 18:05:00');
...
-- Volcando datos para la tabla sisvo_dev.sisvo_empresas: ~3 rows (aproximadamente)
...
CREATE PROCEDURE `config_settings_sp`(
	IN `p_opcion` VARCHAR(50),
	IN `p_empresa_id` INT,
	IN `p_clave` VARCHAR(100), -- Subió a 100 para coincidir con la tabla maestra
	OUT `p_codigo_respuesta` VARCHAR(10),
	OUT `p_mensaje_respuesta` VARCHAR(255)
)
BEGIN
    ...
    IF p_opcion = 'validaConfig' THEN
        ...
        ELSE
            ...
            SELECT 
                ...
                s.`clave` AS Clave,
                COALESCE(e.`valor`, s.`valor_defecto`) AS ValorAplicable,
...
BEGIN
    ...
    -- 🔹 OPCIÓN 4: OpcionB (Espacio de crecimiento para el dominio de Auth)
    ELSEIF p_opcion = 'opcionB' THEN
        SET p_codigo_respuesta = 'SUCCESS';
        SET p_mensaje_respuesta = 'Operación B ejecutada con éxito.';
