...
-- Volcando estructura de base de datos para sisvo_ferreteria
DROP DATABASE IF EXISTS `sisvo_ferreteria`;
CREATE DATABASE IF NOT EXISTS `sisvo_ferreteria` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `sisvo_ferreteria`;

-- Volcando estructura para tabla sisvo_ferreteria.ajustes_sistema
...
-- Volcando estructura para tabla sisvo_ferreteria.msc_estatus_usuarios
...
-- Volcando estructura para tabla sisvo_ferreteria.msc_log_errores_catchs
...
-- Volcando estructura para tabla sisvo_ferreteria.msc_roles
...
-- Volcando estructura para tabla sisvo_ferreteria.msc_usuarios
...
-- Volcando estructura para tabla sisvo_ferreteria.sisvo_empresas
...
-- Volcando estructura para tabla sisvo_ferreteria.sisvo_estatus_empresas
...
-- Volcando estructura para tabla sisvo_ferreteria.sisvo_giros_empresa
...
-- Volcando estructura para tabla sisvo_ferreteria.sisvo_sucursales
...
-- Volcando estructura para tabla sisvo_ferreteria.sisvo_usuarios_empresas
